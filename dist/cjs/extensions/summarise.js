...
var Summarise = /** @class */ (function (_super) {
    __extends(Summarise, _super);
    function Summarise() {
     ...
     * ```
     */
    Summarise.handle = function (num_words) {
        return __awaiter(this, void 0, void 0, function () {
            var data, provider, summary;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this;
                        provider = provider_manager_js_1.ProviderManager.getProvider();
                        return [4 /*yield*/, provider.getResponseString("Summarise the following text in ".concat(num_words, " words"), data)];
                    case 1:
                        summary = _a.sent();
