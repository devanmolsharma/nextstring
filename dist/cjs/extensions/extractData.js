...
var ExtractData = /** @class */ (function (_super) {
    __extends(ExtractData, _super);
     ...
     * ```
     */
    ExtractData.handle = function (items) {
        return __awaiter(this, void 0, void 0, function () {
            var data, provider, query, answer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this;
                        provider = provider_manager_js_1.ProviderManager.getProvider();
                        query = items
                            .map(function (item) { return "Extract ".concat(item.name, ": ").concat(item.description); })
                            .join("\n");
                        return [4 /*yield*/, provider.getResponseJson("Based on the data user provides, extract the following information:\n            ".concat(query, "\n            Only use the data provided and return the answer in JSON format with the following structure:\n            {\n                \"name1\": \"value1\",\n                \"name2\": \"value2\",\n                ...\n            }"), data)];
                    case 1:
                        answer = _a.sent();
