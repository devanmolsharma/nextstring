...
var Question = /** @class */ (function (_super) {
     ...
     * ```
     */
    Question.handle = function (question) {
        return __awaiter(this, void 0, void 0, function () {
            var data, provider, answer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this;
                        provider = provider_manager_js_1.ProviderManager.getProvider();
                        return [4 /*yield*/, provider.getResponseString("Based on the data user provides, answer this question: ".concat(question, ", only use the data provided and return only the answer, nothing else"), data)];
                    case 1:
                        answer = _a.sent();
